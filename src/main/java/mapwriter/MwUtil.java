...
import mapwriter.event.MwStart;
...
public class MwUtil {
	...
	public static void logInfo(String s, Object...args) {
		MwStart.logger.info(String.format(s, args));
	}
	
	public static void logWarning(String s, Object...args) {
		MwStart.logger.warning(String.format(s, args));
	}
	
	public static void logError(String s, Object...args) {
		MwStart.logger.severe(String.format(s, args));
	}
	
	public static void debug(String s, Object...args) {
		MwStart.logger.finest(String.format(s, args));
	}
